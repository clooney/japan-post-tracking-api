Japan Post Tracking API - Java
================================
Use Java to track Japan Post shipments with Japan Post Tracking API.
...
Create a tracking (Real-time tracking):
    ...
    package com.trackingmore.example.japanpost;
    ...
    public class CreateJapanPostTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                createTrackingParams.setTrackingNumber("RN061075020JP");
                createTrackingParams.setCourierCode("japan-post");
...
Create trackings (Max. 40 tracking numbers create in one call):
    ...
    public class CreateJapanPostTrackingsExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                createTrackingParams1.setTrackingNumber("RM129335604IN");
                createTrackingParams1.setCourierCode("japan-post");
                
                CreateTrackingParams createTrackingParams2 = new CreateTrackingParams();
                createTrackingParams2.setTrackingNumber("RN061021865JP");
                createTrackingParams2.setCourierCode("japan-post");
...
Get status of the shipment:
    ...
    public class GetJapanPostTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                # trackingParams.setTrackingNumbers("RM129335604IN,RN061021865JP");
                trackingParams.setCourierCode("japan-post");
...
Update a tracking by ID:
    ...
    public class UpdateJapanPostTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                String idString = "9d8a46505ea0e17b78ab92125b3f0ceb";
