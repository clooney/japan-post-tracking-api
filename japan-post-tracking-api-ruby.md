Japan Post Tracking API - Node.js
================================
Use Node.js to track Japan Post shipments with Japan Post Tracking API.
...
Create trackings (Max. 40 tracking numbers create in one call):
    ...
    begin
      params  = [{"tracking_number" => "RM129335604IN","courier_code"=>"japan-post"},{"tracking_number" => "RN061021865JP","courier_code"=>"japan-post"}]
...
Get status of the shipment:
    ...
    begin
      ...
      # params  = {"tracking_numbers" => "RM129335604IN,RN061021865JP","courier_code"=>"japan-post"}
