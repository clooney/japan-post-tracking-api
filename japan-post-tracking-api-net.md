Japan Post Tracking API - .Net
================================
Use .Net to track Japan Post shipments with Japan Post Tracking API.
      ...
      public class Test
      {
            ...
            static void Main(string[] args)
            {
              try
              {
                  ...
                  createTrackingParams.trackingNumber = "RN061075020JP";
                  createTrackingParams.courierCode = "japan-post";
      ...
      public class Test
      {
            ...
            static void Main(string[] args)
            {
              try
              {
                  ...
                  {
                      trackingNumber = "RM129335604IN",
                      courierCode = "japan-post"
                  };
      ...
      public class Test
      {
            ...
            static void Main(string[] args)
            {
              try
              {
                  ...
                  # getTrackingResultsParams.trackingNumbers = "RM129335604IN,RN061021865JP";
                  getTrackingResultsParams.courierCode = "japan-post";
